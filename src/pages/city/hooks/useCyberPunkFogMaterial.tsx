...
let cachedCyberpunkFogMaterial: THREE.ShaderMaterial | null = null;

export function useCyberpunkFogMaterial() {
  const material = useMemo(() => {
    if (cachedCyberpunkFogMaterial) {
      return cachedCyberpunkFogMaterial;
    }

    cachedCyberpunkFogMaterial = new THREE.ShaderMaterial({
      transparent: true,
