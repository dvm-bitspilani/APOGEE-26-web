  ...
  return (
    <div className={`${styles.card} ${classname ?? ""}`}>
      <div className={`${styles.card1}`}>
        <img src={bg} alt="card background" className={styles.bgIMG1} />
        <img
          src={cardBorders}
          alt="card border"
          className={styles.borderIMG1}
        />
        <img
          src={contact.photo}
          alt={contact.name}
          className={styles.contactIMG1}
        />
        <p className={styles.dept1}>{contact.dept}</p>
        <p className={styles.name1}>{`[${contact.name}]`}</p>
      ...
      {/* <div className={`${styles.card2}`}>
        <img src={bg} alt="card background" className={styles.bgIMG2} />
        <img
          src={cardBorders}
          alt="card border"
          className={styles.borderIMG2}
        />
        <img
          src={contact.photo}
          alt={contact.name}
          className={styles.contactIMG2}
        />
        <p className={styles.dept2}>{contact.dept}</p>
        <p className={styles.name2}>{`[${contact.name}]`}</p>
      ...
      {/* <div className={`${styles.cardInner}`}>
        <img src={bg} alt="card background" className={styles.bgIMGInner} />
        <img
          src={cardBorders}
          alt="card border"
          className={styles.borderIMGInner}
        />
        <img
          src={contact.photo}
          alt={contact.name}
          className={styles.contactIMGInner}
        />
        <p className={styles.deptInner}>{contact.dept}</p>
        <p className={styles.nameInner}>{`[${contact.name}]`}</p>
